...
(() => {
  ...
  async function validateToken() {
    ...
    try {
      const resp = await fetch('https://dckeajeazaxbxlqlkicl.supabase.co/auth/v1/user', {
        headers: {
  ...
  async function login(email, password) {
    try {
      const resp = await fetch('https://dckeajeazaxbxlqlkicl.supabase.co/auth/v1/token?grant_type=password', {
        method: 'POST',
        headers: {
  ...
  async function register(email, password) {
    try {
      const resp = await fetch('https://dckeajeazaxbxlqlkicl.supabase.co/auth/v1/signup', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'apikey': SUPABASE_ANON_KEY
